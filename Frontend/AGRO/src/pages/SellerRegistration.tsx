...
const SellerRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.address || !formData.aadharNumber || !formData.phoneNumber || !formData.tradeLicenseNumber) {
      toast({
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Welcome to VendorConnect as a seller",
        });
        navigate("/shop");
      } else {
        toast({
